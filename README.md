...
Chinese community edition of [superpowers](https://github.com/obra/superpowers) — 10 skills across 16 AI coding tools, including full translations.
...
| 📦 Skills | 🤖 支持工具 |
|:---:|:---:|
| **11** | **Claude Code / Copilot CLI / Hermes Agent / Cursor / Windsurf / Kiro / Gemini CLI / Codex / Aider / Trae / VS Code (Copilot) / DeerFlow / OpenCode / OpenClaw / Qwen Code / Antigravity / Claw Code** |
...
> 运行 `npx superpowers-zh` 会自动检测你项目中使用的工具，将 10 个 skills 安装到正确位置。
...
| 项目 | 定位 | 一句话 |
|------|------|-------|
| **[superpowers-zh](https://github.com/jnMetaCode/superpowers-zh)**（本项目） ![](https://img.shields.io/github/stars/jnMetaCode/superpowers-zh?style=flat&label=⭐) | 🧠 工作方法论 | 10 个 skills 教 AI 怎么干活（TDD / 调试 / 代码审查等） |
